...
class Booking(db.Model):
    ...
    tutor_id = db.Column(db.Integer, db.ForeingKey("tutors.id"), nullable=False)
...
class Request(db.Model):
    ...
    client_name = db.Column(db.String, nullable=False)
    client_phone = db.Column(db.String, nullable=False)
    time_for_practice_id = db.Column(db.Integer, nullable=False)
    time_for_practice = db.relationship('TimeForPractice')
    goal_id = db.Column(db.Integer, db.ForeingKey("goals.id"), nullable=False)
